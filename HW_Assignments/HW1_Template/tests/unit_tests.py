...
def t_csv_find_by_primary_key():
    ...
    csv_tbl = CSVDataTable("people", connect_info, ["playerID", "birthYear", "birthMonth"])
...
def t_csv_find_by_template():
    ...
    print(csv_tbl.find_by_template(None)[:10])
...
def t_csv_delete_by_key():
    ...
    print("Lines removed:", csv_tbl.delete_by_key(["abbotgl01", "1951", "2"]), "should equal 1")
    print("Lines removed:", csv_tbl.delete_by_key(["abbotgl01", "1951", "2"]), "should equal 0")
    print("Lines removed:", csv_tbl.delete_by_key(["abbeych01", "1866", "10"]), "should equal 1")
    try:
...
def t_csv_update_by_key():
    ...
    keys = ["abbotgl01", "1951", "2"]
    new_val = {"deathYear": "123", "deathMonth": "12", "deathDay": "1"}
    print("Lines removed:", csv_tbl.update_by_key(keys, new_val), "should equal 1")
